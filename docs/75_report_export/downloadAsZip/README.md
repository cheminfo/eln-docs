...
1. You can enter a keyword, product code, meta information, etc. to search for your samples
...
1. You can enter an ELN entry code, yield, reagent or product code to search for your ELN entries

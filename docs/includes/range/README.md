...
First, you can specify the range of atoms using the syntax: `<atom letter><minimum>-<maximum>`.
...
You can also use group specification with the same syntax as atoms: `<group abbreviation or molecular formula><minimum>-<maximum>`.
